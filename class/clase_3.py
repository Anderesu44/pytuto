...
#? ============== Ejercicio ============== ?
#Debes crear un programa que pida al usuario su nombre y su edad, y los datos de su acompañante en caso de tenerlo.
#Si alguno de los dos es mayor de edad, dale la bienvenida; en caso contrario, deniega el acceso.
